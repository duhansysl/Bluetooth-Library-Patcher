...
* OneUI 8/9 needs either "libbluetooth_jni.so" or "com.android.bt.apex" so get them from your ROM base and add them into "in" folder
* Patched lib will be copied to "lib_patched" folder and stock one will be copied to "lib_stock" folder. 

### Last updated: 23.09.2026 - 21:54
